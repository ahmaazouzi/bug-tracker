...
class Body extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                <Col id="todoCat" className="rounded-lg border-0 border-light p-0" style={{backgroundColor: "white", height: "auto", minHeight: "85vh", margin: "14px",
                ...
                onDrop={(e) => {this.drop(e, statuses["todoCat"])}} onDragOver={e => this.allowDrop(e)}>
                    ...
                    <div className="card-body" style={{padding: "0.7em", backgroundColor: "rgb(231, 232, 234)"}}>
                ...
                <Col id="inprogressCat" className="rounded-lg border-0 border-light p-0" style={{backgroundColor: "white", height: "auto", minHeight: "85vh", margin: "14px",
                // boxShadow: "0 3px 6px 0 rgba(0, 0, 0, 0.2), 0 4px 16px 0 rgba(0, 0, 0, 0.19)" 
            }}
                ...
                <Col  id="doneCat" className="rounded-lg border-0 border-light p-0" style={{backgroundColor: "white", height: "auto", minHeight: "85vh", margin: "14px",
                // boxShadow: "0 3px 6px 0 rgba(0, 0, 0, 0.2), 0 4px 16px 0 rgba(0, 0, 0, 0.19)"
             }}
