            ...
            <Col xs={1} style={{ backgroundColor: "#102234", height: "auto", minHeight: "100vh" }}>
                ...
                <h3 style={{ color: "white", paddingTop: ".25em", paddingBottom: "2em" }} className="text-center">
                    <a href="#" style={{ color: "white" }}>
                        <svg width="1.7em" height="1.7em" viewBox="0 0 16 16" class="bi bi-hexagon-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <p style={{paddingTop: "2em"}} className="text-center">
                    <a href="#" style={{color: "white"}}>
