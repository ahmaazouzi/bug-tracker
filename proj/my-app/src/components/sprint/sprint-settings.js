  ...
  return (
    <Row className="justify-content-center" style={{}}>
      <Col style={{}} xl="8" className="p-0">
        ...
        <Card style={{ width: '100%', maxHeight: "45%", minHeight: "20%", marginTop: "1em" }} className="rounded-0 border-0">
          <Card.Body className="" style={{ border: "1px solid rgb(211, 211, 211)", backgroundColor: "#F6F6F6", borderBottom: "0px", paddingTop: "5px" }} >
            ...
            <div style={{ maxHeight: "30vh", minHeight: "10vh",overflowY: "scroll" }}>

            <Card style={{ border: "1px dashed darkgrey"}} className="rounded-0">
                <Card.Body className="" style={{ padding: "1em", textAlign: "center", backgroundColor: "#F6F6F6" }} >
                  Drag tickets here
                </Card.Body>
              </Card>
              ...
              {/* <Card style={{ border: "1px solid #5B5B5B", borderLeft: "5px solid red", borderBottom: "0px", border: "1px solid rgb(211, 211, 211)" }} className="rounded-0">
                <Card.Body style={{ padding: "5px" }} >
                  <Row style={{ margin: "0px", padding: "0px" }}>
                    ...
                    <b style={{ color: "grey", width: "10%" }}>Ahmed </b>
        ...
        <Card style={{ width: '100%', minHeight: "20%", maxHeight: "45%" }} className="rounded-0 border-0">
          <Card.Body className="" style={{ border: "1px solid rgb(211, 211, 211)", paddingTop: "5px", backgroundColor: "#F6F6F6" }}>
            <Row className="justify-content-center" style={{ padding: "5px", paddingBottom: "10px" }}>
              ...
              <Col style={{ textAlign: "right", fontSize: "80%", color: "grey" }}><Button style={{ padding: "3px 5px 3px 5px", marginRight: "-4px" }}>Create Sprint</Button></Col>
            </Row>
